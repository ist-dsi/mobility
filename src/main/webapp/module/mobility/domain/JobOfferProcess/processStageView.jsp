...
<bean:define id="mobilityProcessStageView" name="process" property="mobilityProcessStageView" type="module.mobility.domain.util.MobilityJobOfferProcessStageView"/>
