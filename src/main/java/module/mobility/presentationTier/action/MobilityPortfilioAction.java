...
@StrutsFunctionality(app = MobilityAction.class, path = "mobilityPortfilio", titleKey = "link.sideBar.mobility.personalProfile", accessGroup = "logged")
@Mapping(path = "/mobilityPortfilio")
/**
 * 
 * @author Luis Cruz
...
public class MobilityPortfilioAction extends BaseAction {
    ...
    public ActionForward jobOffers(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
        ...
        return new MobilityAction().portfolio(mapping, form, request, response);
    }
