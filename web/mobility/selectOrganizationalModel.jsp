...
<h2><bean:message key="label.mobility.select.organizationalModel" bundle="MOBILITY_RESOURCES"/></h2>
...
<logic:notEmpty name="organizationalModels">
	<chart:orgChart id="organizationalModel" name="organizationalModelChart" type="java.lang.Object">
		<div class="orgTBox orgTBoxLight">
			<html:link action="/mobility.do?method=selectOrganizationalModel" paramId="organizationalModelOid" paramName="organizationalModel" paramProperty="externalId">
